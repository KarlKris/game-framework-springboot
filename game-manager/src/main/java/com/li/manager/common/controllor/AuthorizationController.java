...
import com.li.manager.common.annotation.AnonymousDeleteMapping;
import com.li.manager.common.annotation.AnonymousGetMapping;
import com.li.manager.common.annotation.AnonymousPostMapping;
import com.li.manager.common.exception.ManagerBadRequestException;
import com.li.manager.common.model.AuthUserDto;
import com.li.manager.common.properties.LoginProperties;
import com.li.manager.common.properties.RsaProperties;
import com.li.manager.common.properties.SecurityProperties;
import com.li.manager.common.security.TokenProvider;
import com.li.manager.common.security.config.LoginCodeEnum;
import com.li.manager.utils.RsaUtils;
...
public class AuthorizationController {
    ...
    public Mono<ResponseEntity<Object>> login(@Validated @RequestBody AuthUserDto authUser) throws Exception {
        ...
        if (!StringUtils.hasLength(authUser.getCode()) || !authUser.getCode().equalsIgnoreCase(code)) {
