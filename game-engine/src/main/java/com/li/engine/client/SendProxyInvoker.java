...
public class SendProxyInvoker implements InvocationHandler {
    ...
    /** 方法参数上下文 **/
    private final Map<Method, ProtocolMethodCtx> methodCtxHolder;
    /** 远程调用消息Future容器 **/
    ...
    public SendProxyInvoker(NioNettyClient client, List<ProtocolMethodCtx> protocolMethodCtxes) {
        this.client = client;
        this.methodCtxHolder = new HashMap<>(protocolMethodCtxes.size());
        protocolMethodCtxes.forEach(k -> this.methodCtxHolder.putIfAbsent(k.getMethod(), k));
    }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        ProtocolMethodCtx protocolMethodCtx = this.methodCtxHolder.get(method);
