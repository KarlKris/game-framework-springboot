 ...
 * @date 2022/9/22
 */
public class TriggerEffectSource extends AbstractEffectSource {

    /** 触发器 **/
    private final Trigger receiver;
    /** 触发者 **/
    private final FightUnit unit;

    public TriggerEffectSource(Trigger receiver, @Nullable FightUnit unit) {
